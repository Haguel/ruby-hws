...
File.write('qr.png', qr_png.to_s, mode: 'wb')
...
File.write('barcode.png', barcode_png, mode: 'wb')
...
puts "Barcode валідація: #{QrBarcodeGem::Validator.validate_barcode('123456789012', type: :ean_13)}" # true
